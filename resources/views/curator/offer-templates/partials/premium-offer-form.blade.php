<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <x-adminlte-textarea name="premiumDescription" label="Description" placeholder="Description" rows="5"  fgroup-class="col-md-12" class="input description">
                {!!$OfferTemplate->premiumOffer->description!!}
            </x-adminlte-textarea>
        </div>
    </div>
