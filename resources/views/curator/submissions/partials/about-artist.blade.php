<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">About The Artists</h3>
    </div>
    <div class="card-body">
       
        <div class="text-center my-2">
            <img class="img-fluid" src="{{ $music->artist->profile_image_url ? $music->artist->profile_image_url : asset('/images/default-image.jpg') }}" alt="User profile picture">
        </div>
        <div class="row my-3">
        ...
        <hr>
        {{-- <strong>Email</strong>
        <p class="text-muted">{{ $music->artist->email }}</p>
        <hr> --}}
        <strong>Location</strong>
        <p class="text-muted">{{ $music->artist->location }}</p>
        <hr>
        <strong>Contact</strong>
        <p class="text-muted">{{ $music->artist->contact }}</p>
        <hr>
        <strong>band_name</strong>
        <p class="text-muted">{{ $music->artist->band_name }}</p>
    </div>
</div>