<nav class="main-header navbar
    ...
    <ul class="navbar-nav ml-auto">
        ...
        {{-- wallet icon --}}
        @if (Auth::user()->getRoleNames()[0] == 'curator')
            <div class="pt-1">
