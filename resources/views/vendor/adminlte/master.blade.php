...
<head>
    ...
    {{-- recaptcha --}}
    <script src="https://www.google.com/recaptcha/api.js?render=6LeNitsqAAAAADlYEUAe13urbfgaLP5Ic3fmCijE"></script>
    <script src="https://www.google.com/recaptcha/api.js" async defer></script>
    <script>
        grecaptcha.ready(function() {
            grecaptcha.execute('6LeNitsqAAAAADlYEUAe13urbfgaLP5Ic3fmCijE', {
                action: 'login'
            }).then(function(token) {
