...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We have received your payout request. The details of the request are as follows:</p>
            
            <p><strong>Payout Details:</strong></p>
            <ul>
                <li><strong>Request Date:</strong> {{$trasanction->created_at}}</li>
                <li><strong>Requested Amount:</strong> ${{$trasanction->amount}}</li>
                <li><strong>Payment Method:</strong> Paypal</li>
            </ul>

            <p>Our Team will review and process this request as soon as possible.</p>
