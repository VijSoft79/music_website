    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <label class=" col-form-label">How many total reviews, articles, new posts, etc do you post per week?</label>
                <input type="number" name="total_reviews" value="{{ old('location', Auth::user()->total_reviews) }}" class="form-control" id="inputPassword">
            </div>
            ...
            <div class="col-12">
                <div class="mb-3 row">
                    <label class="col-12 col-form-label">Tell us in detail what kinds of coverage you can offer to the
                        curator that will be submitting songs to our platform</label>
                    <div class="col-sm-12">
